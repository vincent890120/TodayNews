...
import com.example.vincent.todaynews.widget.pulltorefresh.internal.DperLoadingLayout;
import com.example.vincent.todaynews.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.example.vincent.todaynews.widget.pulltorefresh.internal.LoadingLayout;
import com.example.vincent.todaynews.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.example.vincent.todaynews.widget.pulltorefresh.internal.Utils;
import com.example.vincent.todaynews.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
     ...
     * getLoadingLayoutProxy(mode.showHeaderLoadingLayout(),
     * mode.showFooterLoadingLayout()).setPullLabel(
     * pullLabel);
     * }
     */
    ...
    public final void setOnPullScrollListener(OnPullScrollListener<T> listener) {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (mOnPullScrollListener != null) {
            mOnPullScrollListener.onPullScrollRefresh(this, l, t, oldl, oldt);
        }
    }
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection,
            ...
            switch (this) {
                case PEOPLE:
                default:
                    return new DperLoadingLayout(context, mode, scrollDirection, attrs);
                case FLIP:
    ...
    public static interface OnPullScrollListener<V extends View> {

        public void onPullScrollRefresh(final PullToRefreshBase<V> refreshView, int l, int t,
                                        int oldl, int oldt);
